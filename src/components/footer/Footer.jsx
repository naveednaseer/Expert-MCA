                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="footer__bottom">
                                <Link style={{marginTop: "3rem"}} to="/" className="logo"><img style={{maxWidth: "250px"}} src={logo} alt="LOGO" /></Link>

                                <p style={{marginTop: "3rem"}} className="center mb--30">
                                  
                                    <p>© Copyright 2023 Pay My MCA LLC. All rights reserved</p>
                                </p>
                                <ul style={{marginTop: "3rem"}} className="list-social">
                                    <li><Link to="#">
